...
using HealthCareOrganisation.Services;
...
namespace HealthCareOrganisation
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<Context>(op => op.UseSqlServer(builder.Configuration.GetConnectionString("myCon")));
